...
import { Timer, BadgeIndianRupee, Headset } from 'lucide-react';
...
const promises: PromiseItemType[] = [
    { icon: <Timer style={{ color: "#FFF" }} />, text: "We don't rush installations." },
    { icon: <BadgeIndianRupee style={{ color: "#FFF" }} />, text: "We don't hide pricing." },
    { icon: <Headset style={{ color: "#FFF" }} />, text: "We don't disappear after handover." },
];

const OurPromise: React.FC = () => {
    return (
        <SectionWrapper id="our-promise" data-scroll-section>
            <Container maxWidth="lg" sx={{ position: 'relative', zIndex: 2, '@media (max-width: 600px)': { px: '16px' } }}>
